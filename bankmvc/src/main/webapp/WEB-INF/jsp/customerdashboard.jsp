    ...
    <a class="navbar-brand" href="#"><b>ABC Bank</b></a>
         ...
         <div class="collapse navbar-collapse" id="navbarContent">
             ...
             <ul class="navbar-nav ml-auto">
                 <li class="active nav-item"><a class="nav-link" href="/logoutPage"><u>Logout</u></a></li>
			...
			<!--------------------- Details------------------>
		<center>
			<br><h1 style="font-weight: 400; color:white"><b>Welcome to ABC Bank</b></h1>
		</center>
		
				
			<div style="margin: 9em 120em 14em 14em;">
				<div class="card   " style="width: 950px; background: rgb(0, 0, 0); 
  					color: #f1f1f1;">
					<div class="card-body">
						<div align="center">
...
<div class="col-xs-6 col-sm-3 col-md-3">
	<div style="margin: -42.8em 12em 5em 48em;">
					<div class="card   " style=" padding-left: 20;position: relative; width: 400px;height:400px; 
  					background: rgb(0, 0, 0); 
  					color: #f1f1f1;">
					<div class="card-body">
						...
						<br>
						<p style="color: skyblue;" id="message">${transfermsg}</p>
					</div>
				</div>
			</div>
		</div>
